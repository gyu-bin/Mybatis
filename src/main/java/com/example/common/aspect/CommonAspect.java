...
import com.example.authorityManager.exception.DataNotInputException;
...
public class CommonAspect {
    ...
    public class LoggerAspect {
        ...
        @Around("execution(* com..controller.*.*(..)) && execution(* com..serviceFacade.*.*(..)) && execution(* com..applicationService.*.*(..)) && execution(* com..dao.*.*(..))")
