...
public interface ProductionServiceFacade {
	...
	public ArrayList<ContractDetailInMpsAvailableTO>getContractDetailListInMpsAvailable(String searchCondition, String startDate, String endDate);
	...
	//public ArrayList<WorkOrderInfoTO> workSiteLogList(String workSiteLogDate);
