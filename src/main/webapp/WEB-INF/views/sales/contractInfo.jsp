...
<body>
    ...
    <article class="contractInfoGrid">
        <div align="center">
            <div id="contractInfoGrid" class="ag-theme-balham" style="height:30vh; width:auto; text-align: center;"></div>
        </div>
    </article>
    <br/>
    <button id="estimateDetailInsertButton" onclick="addRow(this)">수주상세추가</button>
    <button id="estimateDetailDeleteButton" onclick="deleteRow(this)">선택한상세삭제</button>
    ...
    <article class="contractDetailInfoGrid">
        <div align="center">
            <div id="contractDetailInfoGrid" class="ag-theme-balham" style="height: 30vh;width:auto; text-align: center;"></div>
        </div>
    </article>
...
<div class="modal fade" id="amountModal" role="dialog">
    ...
    <script>
        ...
        const contractInfoGrid = document.querySelector("#contractInfoGrid");
        const contractDetailInfoGrid = document.querySelector("#contractDetailInfoGrid");
 ...
 // o if customer modal hide, next cell
    ...
    function setDataOnCustomerName() {
        ...
        const contractInfoColumn = [
            ...
            { headerName: "견적일련번호", field: "estimateNo", width: 400 },
            { headerName: '수주유형분류', width: 450, field: 'contractTypeName' },
            { headerName: '거래처코드', field: 'customerCode', hide: true },
            { headerName: '거래처명', field: 'customerName', hide: true },
            { headerName: '견적일자', field: 'contractDate', width: 350 },
            { headerName: '수주일자', field: 'contractDate', width: 350 },
            ...
            { headerName: 'personCodeInCharge', field: 'personCodeInCharge' },
        ];
    ...
    // O Button Click evenet
        ...
        document.addEventListener('DOMContentLoaded', () => {
            new agGrid.Grid(contractInfoGrid, contractInfoGridOptions);
            //new agGrid.Grid(contractDetailInfoGrid, estimateDetailInfoGridOptions);
        });
