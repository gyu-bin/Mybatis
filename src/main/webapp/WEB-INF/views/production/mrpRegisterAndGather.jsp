...
<head>
    ...
    <style>
        ...
        #showMrpSimulationButton{
            background-color:#F15F5F;
            border: 1px solid #F15F5F;
        }
        #showMrpSimulationButton:hover{
            background-color:#FFFFFF;
            border: 1px solid #F15F5F;
            color: #F15F5F;
        }
        #showMrpGatheringButton{
            background-color:#F15F5F;
            border: 1px solid #F15F5F;
        }
        #showMrpGatheringButton:hover{
            background-color:#FFFFFF;
            border: 1px solid #F15F5F;
            color: #F15F5F;
        }
    ...
    <div class="contract__Title">
        ...
        <div style="color: black">
            ...
            <input type="radio" name="includeMrpApplyCondition" value="includeMrpApply" id="includeMrpApplyRadio"
                   checked>
            &nbsp<label for="excludeMrpApplyRadio">미포함</label>
        ...
        <button id="showMrpSimulationButton">MRP모의전개</button>
    </div>
</article>
...
<script>
    ...
    const mpsColumn = [
        {
            headerName: "주생산계획번호", field: "mpsNo", suppressSizeToFit: true, headerCheckboxSelection: false,
        ...
        {headerName: 'MRP 적용상태', field: 'mrpApplyStatus', width: 300, cellRenderer:(params) => {
                if (params.value == 'Y') {
    ...
    mpsSearchBtn.addEventListener("click", () => {
    ...
    showMrpSimulationBtn.addEventListener("click", () => {
        let selectedRows   = mpsGridOptions.api.getSelectedRows();
        if (selectedRows === "") {
            Swal.fire("알림", "모의전개할 mps를 선택하십시오.", "info");
            return;
        }
        _setMrpModal();
        getMrpList(mpsRowNode);
        $('#mrpModal').modal('show');
        mpsGridOptions.api.deselectAll(); // 선택 해제
    });
    registerMrpBtn.addEventListener("click", () => {
        if (mrpDate.value === "") {
            Swal.fire("알림", "전개 등록 일자를 입력하십시오.", "info");
            return;
        }
        registerMrp(mrpDate.value);
    });
    ...
    const mrpColumn = [
        ...
        {headerName: '발주/작업 완료기한', field: 'requiredDate', cellRenderer: function (params) {
                if (params.value == null) {
                    params.value = "";
                }
                return '📅 ' + params.value;
