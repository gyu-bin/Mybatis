...
<head>
    ...
    <link rel="icon" type="image/png" href="${pageContext.request.contextPath}webapp/img/camera.png" />
    ...
    <script src="${pageContext.request.contextPath}js/loginForm.js" defer></script>
...
<section id="loginForm">
    <div class="loginForm__content">
        <form method="post" id="form" action="${pageContext.request.contextPath}login.do?method=LogInCheck">
  ...
  <%--  <button type="button" class="btn btn-primary" id="login" style="background-color: #0286ae; outline: none" onclick="loginDo()">LOGIN</button>--%>
